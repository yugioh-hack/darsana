...
// カスタム投稿に特定の機能を付与する
function shard_post_type_support() {
  add_post_type_support( 'how_to_ingress', 'revisions' );
  add_post_type_support( 'how_to_ingress', 'wpcom-markdown' );
}
add_action('init', 'shard_post_type_support');
